package com.example.configclient.aop;

import com.example.configclient.util.LogUtil;
...
public class AopConfig {
    ...
    @Around("execution(* com.example.configclient..controller.*.*(..)) || execution(* com.example.configclient..service.*.*(..))")
    ...
    @Before("execution(* com.example.configclient..controller.*.*(..)) || execution(* com.example.configclient..service.*.*(..))")
    ...
    @AfterReturning(pointcut = "execution(* com.example.configclient..controller.*.*(..)) || execution(* com.example.configclient..service.*.*(..))", returning="retValue")
    ...
    @AfterThrowing(pointcut = "execution(* com.example.configclient..controller.*.*(..)) || execution(* com.example.configclient..service.*.*(..))", throwing = "ex")
